...
ax[0][1].plot( N, 500*(N/N[0])**2.0, 'k-',     lw=2, ms=5, dashes=LStyle_DashDot, label='$N^{2}$' )
...
ax[1][0].legend( loc='lower right', numpoints=1, labelspacing=0.1, handletextpad=0.4,
              borderpad=0.4, handlelength=2.7, fontsize='large' )

ax[0][1].legend( loc='lower right', numpoints=1, labelspacing=0.1, handletextpad=0.4,
              borderpad=0.4, handlelength=2.7, fontsize='large' )
